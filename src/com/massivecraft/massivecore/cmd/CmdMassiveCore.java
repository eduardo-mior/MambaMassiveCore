...
public class CmdMassiveCore extends MassiveCoreCommand
{
	...
	public MassiveCommandVersion cmdMassiveCoreVersion = new MassiveCommandVersion(MassiveCore.get()).setAliases("v", "versao").addRequirements(RequirementHasPerm.get(MassiveCorePerm.VERSION));
