...
public abstract class MassivePlugin extends JavaPlugin implements Listener, Named
{
	...
	public void onEnablePost()
	{
		...
		if (MassiveCoreMConf.get().metricsEnabled)
		{
			...
			{
				String message = Txt.parse("<b>A inicializacao do Mestris falhou :'(");
				log(message);
			}
		}
	...
	{
		if (!Active.class.isAssignableFrom(superClass)) throw new IllegalArgumentException(superClass.getName() + " nao e uma instance de active.");
