...
public enum ParticleEffect {
	...
	public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
		if (!isSupported()) {
			throw new ParticleVersionException("Este efeito de partículas não é suportado pela versão do seu servidor");
		}
		...
		if (hasProperty(ParticleProperty.REQUIRES_WATER) && !isWater(center)) {
			throw new IllegalArgumentException("Não há água no local do centro");
		}
	...
	public void display(Vector direction, float speed, Location center, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
		...
		if (!hasProperty(ParticleProperty.DIRECTIONAL)) {
			throw new IllegalArgumentException("Este efeito de partículas não é direcional");
		}
		if (hasProperty(ParticleProperty.REQUIRES_WATER) && !isWater(center)) {
			throw new IllegalArgumentException("Não há água no local do centro");
		}
	...
	public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException {
		...
		if (!isDataCorrect(this, data)) {
			throw new ParticleDataException("O tipo de dados da particulas esta incorreto");
		}
	...
	public static final class BlockData extends ParticleData {
		 ...
		 * @throws IllegalArgumentException If the material não é um block
		 * @see ParticleData#ParticleData(Material, byte)
		 */
		public BlockData(Material material, byte data) throws IllegalArgumentException {
			super(material, data);
			if (!material.isBlock()) {
				throw new IllegalArgumentException("O material não é um bloco");
			}
		}
	}
	...
	public static final class OrdinaryColor extends ParticleColor {
		...
		public OrdinaryColor(int red, int green, int blue) throws IllegalArgumentException {
			if (red < 0) {
				throw new IllegalArgumentException("O valor vermelho e inferior a 0");
			}
			if (red > 255) {
				throw new IllegalArgumentException("O valor vermelho e superior a 255");
			}
			this.red = red;
			if (green < 0) {
				throw new IllegalArgumentException("O valor verde e inferior a 0");
			}
			if (green > 255) {
				throw new IllegalArgumentException("O valor verde e superior a 255");
			}
			this.green = green;
			if (blue < 0) {
				throw new IllegalArgumentException("O valor azul e inferior a 0");
			}
			if (blue > 255) {
				throw new IllegalArgumentException("O valor azul e superior a 255");
			}
			this.blue = blue;
		}
	...
	public static final class NoteColor extends ParticleColor {
		...
		public NoteColor(int note) throws IllegalArgumentException {
			if (note < 0) {
				throw new IllegalArgumentException("O valor da nota e inferior a 0");
			}
			if (note > 24) {
				throw new IllegalArgumentException("O valor da nota e superior a 24");
			}
			this.note = note;
		}
	...
	/**
	 * Represents a runtime exception that is thrown either if the displayed particle effect is not colorable or if O tipo de cor da particula esta incorreto
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	public static final class ParticlePacket {
		...
		public ParticlePacket(ParticleEffect effect, float offsetX, float offsetY, float offsetZ, float speed, int amount, boolean longDistance, ParticleData data) throws IllegalArgumentException {
			initialize();
			if (speed < 0) {
				throw new IllegalArgumentException("A velocidade e inferior a 0");
			}
			if (amount < 0) {
				throw new IllegalArgumentException("O valor e inferior a 0");
			}
			this.effect = effect;
