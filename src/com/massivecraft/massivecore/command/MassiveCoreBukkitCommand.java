...
public class MassiveCoreBukkitCommand extends Command implements PluginIdentifiableCommand
{
	...
	// Happens when:
	//	1. Use possible suggestions has the same common prefix.
	...
	public List<String> tabComplete(CommandSender sender, String alias, String[] rawArgs) throws IllegalArgumentException
	{
		...
		if (sender == null) throw new IllegalArgumentException("o remetente nao deve ser nulo");
		if (rawArgs == null) throw new IllegalArgumentException("os args nao devem ser nulos");
		if (alias == null) throw new IllegalArgumentException("os args nao devem ser nulos");
