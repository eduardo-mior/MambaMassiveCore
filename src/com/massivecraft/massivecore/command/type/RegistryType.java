...
public class RegistryType
{
	...
	public static Type<?> getType(Field field, java.lang.reflect.Type fieldType, boolean strictThrow)
	{
		...
		if (fieldType != null)
		{
			...
			if (fieldType instanceof Class)
			{
				...
				if (strictThrow && type == null) throw new IllegalStateException(fieldType + " não está registrado.");
				return type;
			}
		...
		throw new IllegalArgumentException("Nenhuma informação fornecida.");
	}
	...
	// DEFAULTS
	// -------------------------------------------- //
	// NOTE: As of 2016-05-17 about 15% of use servers are still using 1.7.x.
