...
public class Txt
{
	...
	{
		if (InventoryUtil.isNothing(itemStack)) return Txt.parse("<silver><em>Nada");
	...
	public static List<Mson> getPage(List<?> lines, int pageHumanBased, Object title, int pageheight, MassiveCommand command, List<String> args)
	{
		...
		{
			throw new IllegalArgumentException("As linhas devem ser String ou Mson.");
		}
	...
	public static String getTimeDeltaDescriptionRelNow(long millis)
	{
		...
		if (unitCountParts.size() == 0) return "Agora mesmo";
