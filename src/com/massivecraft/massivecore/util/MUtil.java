...
public class MUtil
{
	...
	public static Collection<Player> getOnlinePlayers()
	{
		...
		{
			throw new RuntimeException("Erro ao tentar obter o numero de players online.");
		}
	}
	...
	{
		if (numbers == null) throw new NullPointerException("numeros");
	...
	public static <T extends Number> double getAverage(Iterable<T> numbers)
	{
		...
		if (count == 0) throw new IllegalArgumentException("numeros vazios");
	...
	public static int getChatColorCode(ChatColor chatColor)
	{
		...
		throw new IllegalArgumentException("A cor de chat " + chatColor.name() + " ainda não é suportada!");
	}
	...
	public static ChatColor getChatColor(int chatColorCode)
	{
		...
		throw new IllegalArgumentException("O codigo de chat " + chatColorCode + " ainda não é suportado!");
	}
	...
	public static ChatColor getChatColor(DyeColor dyeColor)
	{
		...
		throw new IllegalArgumentException("A cor de corante " + dyeColor + " ainda não é suportada!");
	}
